...
var mainleftclickeds *sdl.Surface
var mainleftclicked = []byte("\x42\x4d\x8a\x04\x00\x00\x00\x00\x00\x00\x8a\x00\x00\x00\x7c\x00" +
    "\x00\x00\x10\x00\x00\x00\x10\x00\x00\x00\x01\x00\x20\x00\x03\x00" +
    "\x00\x00\x00\x04\x00\x00\x25\x16\x00\x00\x25\x16\x00\x00\x00\x00" +
    "\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff\x00\x00\xff\x00\x00\xff" +
    "\x00\x00\xff\x00\x00\x00\x42\x47\x52\x73\x00\x00\x00\x00\x00\x00" +
...
var mainrightclickeds *sdl.Surface
var mainrightclicked = []byte("\x42\x4d\x8a\x04\x00\x00\x00\x00\x00\x00\x8a\x00\x00\x00\x7c\x00" +
    "\x00\x00\x10\x00\x00\x00\x10\x00\x00\x00\x01\x00\x20\x00\x03\x00" +
    "\x00\x00\x00\x04\x00\x00\x13\x0b\x00\x00\x13\x0b\x00\x00\x00\x00" +
    "\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff\x00\x00\xff\x00\x00\xff" +
    "\x00\x00\xff\x00\x00\x00\x42\x47\x52\x73\x00\x00\x00\x00\x00\x00" +
    ...
    "\x00\x00\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x00\xb3\xbe\xff\x88" +
    "\xfa\xff\xff\x22\xd7\xdf\xff\x00\xce\xd7\xff\x00\xc5\xcf\xff\x00" +
    "\xbc\xc7\xff\x00\xb3\xbe\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x00" +
    "\x00\x00\xff\x00\x00\x00\xff\x00\x00\x00\xff\x00\x00\x00\xff\x00" +
    "\x00\x00\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x00\xb3\xbe\xff\x88" +
    "\xfa\xff\xff\x42\xe0\xe8\xff\x22\xd7\xdf\xff\x00\xce\xd7\xff\x00" +
    "\xc5\xcf\xff\x00\xbc\xc7\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x00" +
    "\x00\x00\xff\x00\x00\x00\xff\x00\x00\x00\xff\x00\x00\x00\xff\x00" +
    "\x00\x00\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x00\xb3\xbe\xff\x88" +
    "\xfa\xff\xff\x5c\xe9\xf0\xff\x42\xe0\xe8\xff\x22\xd7\xdf\xff\x00" +
    "\xce\xd7\xff\x00\xc5\xcf\xff\x00\xb3\xbe\xff\x88\xfa\xff\xff\x88" +
...
func InitSprites() {
    ...
    rwops = sdl.RWFromMem(unsafe.Pointer(&mainleftclicked[0]), len(mainleftclicked))
    mainleftclickeds,_ = sdl.LoadBMP_RW(rwops,1)
    rwops = sdl.RWFromMem(unsafe.Pointer(&mainright[0]), len(mainright))
    mainrights,_ = sdl.LoadBMP_RW(rwops,1)
    rwops = sdl.RWFromMem(unsafe.Pointer(&mainrightclicked[0]), len(mainrightclicked))
    mainrightclickeds,_ = sdl.LoadBMP_RW(rwops,1)
